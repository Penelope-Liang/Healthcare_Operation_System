...
| REQ-012 | REST API endpoints return JSON and support resource CRUD validation. | TC-022, TC-023, TC-024, TC-025 | `tests/e2e/api.spec.js`, `tests/e2e/database-write.spec.js` |
| REQ-013 | Automated QA checks run in CI and publish test evidence. | TC-026 | `.github/workflows/qa.yml`, `playwright-report/` artifact |
